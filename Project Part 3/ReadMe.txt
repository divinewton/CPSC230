...
The round's outcome is then calculated using the dice roll function and the attack and damage function which are located within the Character class.
The round's results are saved to the transcript using the transcription function, and are also printed using the PrintResults function.
